...
local Window = Rayfield:CreateWindow({
    Name = "MM2 Autofarm | Upright Mode by Yureiii",
    LoadingTitle = "Initializing Autofarm...",
    LoadingSubtitle = "Safe Step Tweening",
...
-- Step-tween movement without anchoring or rotating
local function safeTweenTo(targetPos)
    ...
    for i = 1, steps do
        ...
        local tween = ts:Create(humPart, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
...
MainTab:CreateToggle({
    Name = "BeachBall Autofarm (Upright Safe Mode)",
    CurrentValue = false,
